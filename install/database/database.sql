...
`id` int(11) unsigned NOT NULL,
  ...
  `logo` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'assets/img/logo.png'
...
(1, 'Afridi', NULL, NULL, 'Khan', 'Peshawar Mall Tower Sadar Cantt.', 'Pakistan ', '25000', 'admin@ithinq.net', '091200000000', '09100012000', 'B786AA', 'T92RtmQ', 'lorem lorem lorem lorem lorem lorem lorem ', 'assets/images/logo.png');
